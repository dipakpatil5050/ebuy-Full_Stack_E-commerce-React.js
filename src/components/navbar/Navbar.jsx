            ...
            >
              ...
              >
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  <Link
                    to={"/allproducts"}
                    className="text-sm font-medium hover:text-pink-500 text-gray-900"
                  ...
                  {user?.user?.email === "dipakup.a04@gmail.com" ? (
                    <div className="flow-root">
                      <Link
                        to={"/dashboard"}
                        className="-m-2 block p-2 font-medium text-gray-900"
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  <Link
                    to={"/allproducts"}
                    className="text-sm font-medium hover:text-pink-500 text-gray-700 "
                    style={{ color: mode === "dark" ? "white" : "" }}
                  >
                    All Products
                  </Link>
                  ...
                  {user ? (
                    <a
                      onClick={logout}
                      className="text-sm font-medium text-gray-700 hover:text-pink-500 cursor-pointer  "
                      style={{ color: mode === "dark" ? "white" : "" }}
                    >
                      Logout
                    </a>
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a
                    href="#"
                    className="flex items-center hover:text-pink-500 text-gray-700 "
                  >
                    <img
